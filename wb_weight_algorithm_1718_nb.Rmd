---
title: "R Notebook: 17-18 Weighbridge algorithm exploration"
...
setwd("Z:/Informatics/S031/analyses/wb/weight algorithms/wb2_and_3/1718")

#Work with the weigbhridge csv created by foxpro
platsum <- read.csv("avidsum_1718.csv", header = TRUE, sep=",", dec= ".")
...
platsum_filt <- filter(platsum, calc_wt>=2.5 & calc_wt<=6.5 & sd_calcwt<=.50 & nw>100)
...
bestmodel<-lm(calc_wt ~ avgwt+nw+wt40dwt10+wt60dwt10+wt80dwt10, data = platsum_filt)
summary(bestmodel)
plot(bestmodel)
...
write.csv(platsum, "wbdata_1718_pred_wts.csv")     
