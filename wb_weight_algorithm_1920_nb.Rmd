---
title: 'R Notebook: 19-20 Weighbridge algorithm exploration'
output:
  html_document:
    df_print: paged
---
...
setwd("Z:/Informatics/S031/analyses/wb/weight algorithms/wb2_and_3/1920")

#Work with the weigbhridge csv created by foxpro
platsum <- read.csv("avidsum1920.csv", header = TRUE, sep=",", dec= ".")
...
bestmodel<-lm(calc_wt ~ avgwt+maxwt+medwt+nw+wt100dwt10+wt80dwt10, data = platsum_filt)
summary(bestmodel)
plot(bestmodel)
...
write.csv(platsum, "wbdata_1920_pred_wts.csv")     
