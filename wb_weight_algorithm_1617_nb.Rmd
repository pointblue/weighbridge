---
title: "R Notebook: 16-17 Weighbridge algorithm exploration"
...
setwd("Z:/Informatics/S031/analyses/wb/weight algorithms/wb2_and_3/1617")

#Work with the weigbhridge csv created by foxpro
platsum <- read.csv("avidsum_1617.csv", header = TRUE, sep=",", dec= ".")
...
platsum_filt <- filter(platsum, calc_wt>=2.5 & calc_wt<=6.5 & sd_calcwt<=.30 & nw>100)
...
bestmodel<-lm(calc_wt ~ avgwt+maxwt+wt20dwt10+wt40dwt10, data = platsum_filt)
summary(bestmodel)
plot(bestmodel)
...
write.csv(platsum, "wbdata_1617_pred_wts.csv")     
